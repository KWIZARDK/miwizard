...
ADDONID = 'plugin.program.favoritos.wizardk18'
...
if not ROOT:
    ROOT = 'special://profile/addon_data/plugin.program.favoritos.wizardk18/'
...
def verifyLocation():
    ...
    profile  = 'special://profile/addon_data/plugin.program.favoritos.wizardk18/'
    userdata = 'special://userdata/addon_data/plugin.program.favoritos.wizardk18/'
...
def WriteKeymap(start, end):
    filename = KEYMAP_HOT
    cmd      = 'XBMC.RunScript(special://home/addons/plugin.program.favoritos.wizardk18/hot.py)'
