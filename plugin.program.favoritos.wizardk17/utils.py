...
ADDONID = 'plugin.program.favoritos.wizardk17'
...
if not ROOT:
    ROOT = 'special://profile/addon_data/plugin.program.favoritos.wizardk17/'
...
def verifyLocation():
    ...
    profile  = 'special://profile/addon_data/plugin.program.favoritos.wizardk17/'
    userdata = 'special://userdata/addon_data/plugin.program.favoritos.wizardk17/'
