...
APKFILE        = 'https://github.com/KWIZARDK/kwizardk.github.io/blob/master/apks.txt'
...
# Current Theme Header / %s is the menu item and is required
THEME6         = '[LOWERCASE][CAPITALIZE][COLOR '+COLOR1+']Version WizardK a instalar:[COLOR '+COLOR2+']%s[/COLOR][/CAPITALIZE][/LOWERCASE]'

# Message for Contact Page
# Enable 'Contact' menu item 'Yes' hide or 'No' dont hide
HIDECONTACT    = 'No'
# You can add \n to do line breaks
CONTACT        = 'Gracias por utilizar WizardK'
...
# Font size of header
FONTHEADER     = 'Font14'
HEADERMESSAGE  = 'New WizardK'
# url to image if using Image 424x180
HEADERIMAGE    = 'http://'
# Font for Notification Window
FONTSETTINGS   = 'Font13'
# Background for Notification Window
BACKGROUND     = 'https://archive.org/download/wizardk_201812/icon.png'
#########################################################
