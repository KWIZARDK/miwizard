...
if not ROOT:
    ROOT = 'special://home/addons/plugin.program.favoritos/'
...
def verifyLocation():
    ...
    profile  = 'special://home/addons/plugin.program.favoritos/'
    userdata = 'special://userdata/addon_data/plugin.program.favoritos/'
...
def WriteKeymap(start, end):
    filename = KEYMAP_HOT
    cmd      = 'XBMC.RunScript(special://home/addons/plugin.program.favoritos/hot.py)'
